...
const int C[SIZE_OF_CHARS] = { 0b0111110000000000, 0b0100010000000000, 0b0100010000000000 };
...
const int L[SIZE_OF_CHARS] = { 0b0111110000000000, 0b0100000000000000, 0b0100000000000000 };
